...
//	A injeção pode ser feita diretamente acima do objeto ou no construtor da classe
//	desde que o construtor receba o objeto injetado como parâmetro
	...
	public void setHelper(MessageHelper helper) {
		this.helper = helper;
	}
}
